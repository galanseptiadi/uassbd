...
<body>
 <!-- Custom styles for this template-->
    ...
    <div id="wrapper">
        ...
        <div style="margin:1%;">
        <a class="btn btn-primary" href="pasien_tambah.php" role="button"><i class="fa-solid fa-trash-can"></i>Tambah Pasien</a>
        </div>
<div class="card">
    <div class="galan">
    <table class="table table-striped">
        ...
        while ($data = mysqli_fetch_array($query)) {
            ...
            <tr>
                ...
                <td><a class="btn btn-success" href="pasien_ubah.php?id=<?= $data['id_pasien'];?>" role="button"><i class="fa-solid fa-pen-to-square"></i>edit</a>
