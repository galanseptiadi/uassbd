...
<div id="wrapper">
    ...
    <!-- End of Sidebar -->
        ...
        <div style="margin:1%;">
        <a class="btn btn-primary" href="user_tambah.php" role="button"><i class="fa-solid fa-trash-can"></i>User Tambah</a>
        </div>
        <div class="card">
        <div class="galan">
        ...
        <thead class="bg-warning text-dark">
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" href="user_ubah.php?id=<?= $data['id'];?>" role="button"><i class="fa-solid fa-pen-to-square"></i>edit</a>
